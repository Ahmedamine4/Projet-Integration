...
describe('github.controller', () => {
  ...
  it('getUserContributions retourne 404 si utilisateur sans token', async () => {
    prismaMock.etudiant.findUnique.mockResolvedValue({
      etudiant_utilisateur_id: 'etu-2',
      portfolio: { portfolio_id: 'port-2' },
    });
    prismaMock.repository.findFirst.mockResolvedValue(null);
  ...
  it('getUserContributions retourne 400 si la recuperation GitHub echoue', async () => {
    prismaMock.etudiant.findUnique.mockResolvedValue({
      etudiant_utilisateur_id: 'etu-2',
      portfolio: { portfolio_id: 'port-2' },
    });
    ...
    githubServiceMock.getUserContributions.mockRejectedValue(new Error('github down'));
