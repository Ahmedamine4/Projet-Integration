...
describe('notification.controller', () => {
  ...
  it('lireNotification retourne 500 avec le message service si la notification est interdite', async () => {
  ...
  it('supprimerNotificationController retourne 500 si la notification est introuvable', async () => {
