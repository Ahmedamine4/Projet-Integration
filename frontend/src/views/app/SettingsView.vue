      ...
      <section class="card">
        ...
        <div class="card-body">
          <div class="row-item">
            ...
            <a class="btn btn-ghost btn-sm" href="https://github.com" target="_blank" rel="noopener noreferrer">Link GitHub</a>
          </div>
        </div>
      </section>
...
/* Input component error state (applies when we pass the class to Input) */
